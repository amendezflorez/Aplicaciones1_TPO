...
/**
 * Paso 1 del flujo OTP: la persona ingresa su email y le pedimos
 * al backend que dispare el código de validación.
 * Cubre tanto el alta de un usuario nuevo como el login de uno existente
 * (el backend decide qué hacer según si el email ya está registrado).
 */
